...
local pixelfont="Interface\\AddOns\\!koccmedia\\fonts\\visitor.ttf"
local ttfont="Interface\\AddOns\\!koccmedia\\fonts\\calibri.ttf"

local smallfont={pixelfont,12,"OUTLINE,MONOCHROME"}
local medfont={ttfont,16,"OUTLINE"}
local bigfont={ttfont,24,"OUTLINE"}
...
if debug then
	...
	debugback:SetPoint("TOPLEFT",xp,-yp)
	debugback:SetPoint("BOTTOMRIGHT",-xp,yp)
...
l:SetPoint("BOTTOM",UIParent,"CENTER",0,-yp)
...
local function Shared(self,unit)
	...
	if unit=="player" or unit=="target" then -- hp, pp bar
		...
		if unit=="player" then --skull
			...
			skulltex="Interface\\AddOns\\!koccmedia\\textures\\s"
...
--[[ debug
	...
	if unit=="target" then
		...
		local debuffs=CreateFrame("Frame",nil,self)
		debuffs:SetPoint("TOPLEFT",UIParent,"CENTER",-xp,yp)
...
oUF:Factory(function(self)
	...
	self:Spawn("player","oUF_player"):SetPoint("BOTTOMLEFT",UIParent,"CENTER",0,-yp)
