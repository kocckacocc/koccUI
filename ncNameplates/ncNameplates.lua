...
local barcolor = {1,1,1}
local fontsize = 10
local font = "Interface\\AddOns\\!koccmedia\\fonts\\visitor.ttf"
local statusbar = texture
local solid = texture
local flags = "OUTLINE,MONOCHROME"
...
local UpdateFrame = function(self)	
	...
	self.name:SetTextColor(r, g, b, 0)
