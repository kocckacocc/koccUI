...
bp={
	[1]={
		[1]={a="BOTTOMRIGHT",p="CENTER",x=xp,y=-yp+bs+bsp},
		[2]={a="BOTTOMRIGHT",p="CENTER",x=xp,y=-yp},
		[3]={a="TOPRIGHT",p="CENTER",x=xp,y=0},
	},
	[2]={a="BOTTOMRIGHT",p="BOTTOMRIGHT",x=0,y=0},
	[3]={a="BOTTOMRIGHT",p="BOTTOMRIGHT",x=-xp,y=0},
	[4]={a="BOTTOMRIGHT",p="BOTTOMRIGHT",x=-xp+(bs+bsp)*4,y=0},
